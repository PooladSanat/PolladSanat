                                    ...
                                    <div class="col-md-12">
                                        <div class="nav-tabs-custom">
                                            <ul class="nav nav-tabs" style="background-color: rgba(0,105,255,0.07)">
                                                <li class="active" style="width: 33%;"><a href="#a" data-toggle="tab">
                                                        برنامه های تولیدی</a></li>
                                                <li style="width: 33%;"><a href="#b" data-toggle="tab">
                                                        توقفات</a></li>
                                                <li style="width: 32%;"><a href="#c" data-toggle="tab">درخواست ها</a>
                                                </li>
                                            </ul>
...
<div class="modal fade" id="ajaxModel_devicee" aria-hidden="true">
    <div class="modal-dialog col-md-12">
        <div class="modal-body col-md-12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <form autocomplete="off" id="productForm" name="productForm">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-striped table-bordered information_dateee"
                                               id="information_dateee">
